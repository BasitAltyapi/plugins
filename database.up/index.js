...
module.exports = new Underline.Plugin({
  ...
  implements: {
    ...
    properties: {
      ...
      addModel: "(name: string, schema: import(\"mongoose\").Schema, collection?: string, options?: import(\"mongoose\").CompileModelOptions) => import(\"mongoose\").Model<any, {}, {}, {}>",
      getModel: "(name: string) => import(\"mongoose\").Model<any, {}, {}, {}>",
